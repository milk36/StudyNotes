...
* RunNetThreadOperator 网络线程执行的操作
...
* UpdateInMainThread 主线程执行的操作
  ...
  注册主线程网络回调逻辑 参考: `NetServerComponentSystem.AwakeSystem`
...
* KService的计时器
* InitKcp 参数设置 [可参考kcp设置](https://github.com/skywind3000/kcp/wiki/KCP-Basic-Usage)
...
* `KService`
  ...
  public sealed class KService: AService
  {
    ...
    public override void Update()
    {
        ...
        this.Recv();
        this.UpdateChannel(timeNow); // 驱动Channel
    }
  }
  ```
