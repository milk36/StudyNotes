...
- [网络游戏架构设计 笔记四](#网络游戏架构设计-笔记四)
  - [软路由原理](#软路由原理)
    - [常见黑客攻击方式](#常见黑客攻击方式)
    - [Http防攻击方法](#http防攻击方法)
    - [游戏服务器和Http不同](#游戏服务器和http不同)
    - [游戏服务器的弱点](#游戏服务器的弱点)
    - [大部分黑客特点](#大部分黑客特点)
    - [针对性解决](#针对性解决)
    - [防攻击的目标](#防攻击的目标)
    - [软路由方案, 增加类似CDN的东西](#软路由方案-增加类似cdn的东西)
    - [软路由所需的配置](#软路由所需的配置)
    - [ET KCP消息格式](#et-kcp消息格式)
    - [ET 软路由结构图](#et-软路由结构图)
    - [ET 软路由连接流程](#et-软路由连接流程)
    - [ET 软路由消息转发流程](#et-软路由消息转发流程)
  - [Client 软路由代码实现](#client-软路由代码实现)
    - [LoginHelper 登录 Realm和Gate逻辑](#loginhelper-登录-realm和gate逻辑)
    - [RouterAddressComponent 获取软路由与负载服务 列表](#routeraddresscomponent-获取软路由与负载服务-列表)
    - [RouterHelper 创建软路由Session](#routerhelper-创建软路由session)
    - [RouterHelper RouterSYN/RouterReconnectSYN -\> RouterACK/RouterReconnectACK](#routerhelper-routersynrouterreconnectsyn---routerackrouterreconnectack)
    - [RouterCheckComponent 软路由超时判断](#routercheckcomponent-软路由超时判断)
  - [Server 软路由代码实现](#server-软路由代码实现)
    - [RouterNode](#routernode)
    - [RouterComponent 属性](#routercomponent-属性)
    - [RouterComponent 初始化](#routercomponent-初始化)
  - [RouterComponent.RecvOuterHandler 接受外网信息](#routercomponentrecvouterhandler-接受外网信息)
    - [RecvOuterHandler RouterSYN -\> RouterACK](#recvouterhandler-routersyn---routerack)
    - [RecvOuterHandler SYN 转发给内网节点](#recvouterhandler-syn-转发给内网节点)
    - [RecvOuterHandler RouterReconnectSYN 重连路由](#recvouterhandler-routerreconnectsyn-重连路由)
    - [KService.Recv RouterReconnectSYN](#kservicerecv-routerreconnectsyn)
    - [CheckOuterCount 每秒转发包数量检测](#checkoutercount-每秒转发包数量检测)
    - [RecvOuterHandler MSG 转发给内网节点](#recvouterhandler-msg-转发给内网节点)
  - [RouterComponent.RecvInnerHandler 接受内网消息](#routercomponentrecvinnerhandler-接受内网消息)
    - [RecvInnerHandler ACK](#recvinnerhandler-ack)
    - [RecvInnerHandler RouterReconnectACK](#recvinnerhandler-routerreconnectack)
    - [RecvInnerHandler MSG 转发给内Client](#recvinnerhandler-msg-转发给内client)
...
```c#
//---- RouterSYN -> RouteACK (C->R)
2023-09-15 23:00:34.4391 (RouterComponentSystem.cs:614) router new: outerConn: 1879078261 innerConn: 0 127.0.0.1:54282 // 新增 RouterNode 数据
2023-09-15 23:00:34.4391 (RouterComponentSystem.cs:262) router create: 127.0.0.1:30002 471607816 1879078261 0 127.0.0.1:54282 // 创建 RouterNode 的信息打印 

//---- SYN -> ACK (C->R->Realm->R->C)
2023-09-15 23:00:34.4540 (RouterComponentSystem.cs:340) kcp router syn: 1879078261 0 127.0.0.1:30002 127.0.0.1:54283 // 软路由节点转发 SYN 包到内网
2023-09-15 23:00:34.4540 (KChannel.cs:101) channel create: 4294967294 1879078261 127.0.0.1:49270 Accept // KCP Channel 连接创建
2023-09-15 23:00:34.4540 (KService.cs:344) kservice syn: 4294967294 1879078261 4294967294 // 内网节点回复 ACK 包
2023-09-15 23:00:34.4540 (RouterComponentSystem.cs:513) kcp router ack: 1879078261 4294967294 127.0.0.1:54283 //将内网节点的 ACK包 转发给Client
```
...
[RouterComponent RecvOuterHandler 接受外网信息](#routercomponent-recvouterhandler-接受外网信息)
